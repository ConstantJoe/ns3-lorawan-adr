...
#include "ns3/lorawan-frame-header-uplink.h"
...
LorawanPacketTestCase::DoRun (void)
{
  ...
  LoRaWANFrameHeaderUplink receiverFHdr;
  ...
  NS_TEST_ASSERT_MSG_EQ (receiverFHdr.getClassB(), false, "Class B settings do not match");
